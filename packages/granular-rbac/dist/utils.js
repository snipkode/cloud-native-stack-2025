 ...
 */
function evaluateResourceCondition(condition, resource) {
    if (!condition.field)
        return false;
 ...
 */
function evaluateContextCondition(condition, context) {
    if (!condition.field)
        return false;
 ...
 */
function permissionMatches(permission, action, resourceType) {
